...
pose = PoseSteamped.from_list([2.4, 2, 1.0], [0, 0, 0, 1])
...
tool_pose = PoseSteamped.from_list([2.0449586673391935, 1.5384467778416917, 1.09705326966067], [0, 0, 0, 1])
obj_tool_.pose = tool_pose
location_pose = PoseSteamped.from_list([1.7, 2, 0])
looking_pose = PoseSteamped.from_list([2.5, 2, 0.97])
