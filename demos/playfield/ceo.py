...
from demos.playfield.experiment import Experiment
...
from demos.playfield.sandcastle import generic_plan, GenericCode, languagePlanTest
...
print("We start by creating stuff"*10)
...
print("We Check for environmnets"*10)
# Get Environments
...
def runWorld():
    ...
    milk = Object("milk", ObjectType.MILK, "milk.stl", pose=Pose([1, -1.78, 0.55], [1, 0, 0, 0]),
                  color=Color(1, 0, 0, 1))
    for robot in robots: # ToDo: Generic
        ...
        for environment in known_environments:
            ...
            try:
                ...
                print("enviroment: {}\n Robot:{}\n languagePlan:{}".format(environment, robot,languagePlanTest))
                setupNr1=Experiment(environment["name"],robot,Code(languagePlanTest))
