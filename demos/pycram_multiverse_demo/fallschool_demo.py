...
robot = Object('pr2', pycrap.Robot, f'pr2.urdf', pose=PoseSteamped.from_list([1.3, 2.6, 0.01]))
...
milk = Object("milk", pycrap.Milk, milk_path, pose=PoseSteamped.from_list([0.4, 2.6, 1.34],
                                                               [1, 0, 0, 0]),
              color=Color(1, 0, 0, 1))
...
with real_robot:
    ...
    NavigateAction(target_locations=[PoseSteamped.from_list([1.4, 3.15, 0.01], quaternion_from_euler(0, 0, 3.14))]).resolve().perform()
