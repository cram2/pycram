...
if __name__ == "__main__":
    ...
    gripper = Object(
        "gripper-2F-85", pycrap.Gripper, "robotiq/gripper-2F-85/gripper-2F-85.urdf"
    )
    ...
    gripper.set_pose(
        PoseStamped.from_list(
            [0, 0.1, 0], [1.0, 0.0, 0.0, -1.0], frame_id=wrist_3_tf_frame
        )
    )
    ...
    # Get the robot arms
    robot_arms = [
        chain.arm_type for chain in robot.robot_description.get_manipulator_chains()
    ]
