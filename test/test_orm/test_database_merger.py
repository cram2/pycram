...
class ExamplePlans:
    def __init__(self):
        ...
        self.milk = Object("milk", ObjectType.MILK, "milk.stl", pose=PoseSteamped.from_list([1.3, 1, 0.9]))
        self.cereal = Object("cereal", ObjectType.BREAKFAST_CEREAL, "breakfast_cereal.stl", pose=PoseSteamped.from_list([1.3, 0.7, 0.95]))
