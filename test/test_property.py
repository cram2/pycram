...
class TestCaseProperty(KnowledgeSourceTestCase):
    def test_and_construct(self):
        prop_1 = TestProperty(PoseSteamped.from_list([1, 2, 3]))
        prop_2 = TestProperty(PoseSteamped.from_list([1, 2, 3]))
    ...
    def test_property_execute_true(self):
        prop_1 = TestProperty(PoseSteamped.from_list([1, 2, 3], frame_id="pose1"))
        prop_2 = TestProperty(PoseSteamped.from_list([1, 2, 3], frame_id="pose2"))
        prop_3 = prop_1 & prop_2
        resolved_property = self.knowledge_engine.resolve_properties(prop_3)
        resolved_property()
        self.assertTrue(resolved_property.resolved)
        self.assertTrue(resolved_property.successful)
        self.assertEqual(resolved_property.variables, {"pose1": PoseSteamped.from_list([1, 2, 3], frame_id="pose1"),
                                                       "pose2": PoseSteamped.from_list([1, 2, 3], frame_id="pose2")})
        self.assertTrue(resolved_property.executed)

    def test_property_execute_false(self):
        prop_1 = TestProperty(PoseSteamped.from_list([1, 2, 3], frame_id="pose1"))
        prop_2 = TestProperty(PoseSteamped.from_list([9, 9, 9], frame_id="pose2"))
        prop_3 = prop_1 & prop_2
        resolved_property = self.knowledge_engine.resolve_properties(prop_3)
        ...
        self.assertTrue(resolved_property.executed)
        self.assertEqual(resolved_property.variables, {"pose1": PoseSteamped.from_list([1, 2, 3], frame_id="pose1"),
                                                       "pose2": PoseSteamped.from_list([9, 9, 9], frame_id="pose2")})

    def test_property_execute_and_sparse(self):
        prop_1 = TestProperty(PoseSteamped.from_list([9, 9, 9], frame_id="pose1"))
        prop_2 = TestProperty(PoseSteamped.from_list([1, 2, 3], frame_id="pose2"))
        prop_3 = prop_1 & prop_2
        resolved_property = self.knowledge_engine.resolve_properties(prop_3)
        self.assertRaises(ReasoningError, resolved_property)
        ...
        self.assertEqual(resolved_property.variables, {"pose1": PoseSteamped.from_list([9, 9, 9], frame_id="pose1")})
        self.assertTrue(resolved_property.executed)
