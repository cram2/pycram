...
class TestCacheManager(BulletWorldTestCase):
    ...
    def test_generate_description_and_write_to_cache(self):
        ...
        apartment = Object("apartment", ObjectType.ENVIRONMENT, path, ObjectDescription)
        cache_manager.generate_description_and_write_to_cache(path, extension, cache_path,
