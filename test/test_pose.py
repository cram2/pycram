...
class TestPose(BulletWorldTestCase):
    ...
    def test_transform_creation(self):
        t = TransformStamped.from_list([1, 2, 3], [0, 0, 0, 1], self.world.root, self.test_body)
    ...
    def test_transform_edit(self):
        t = TransformStamped.from_list([3, 2, 1], [0, 1, 0, 0], self.world.root, self.test_body)
    ...
    def test_transform_copy(self):
        t = TransformStamped.from_list([1, 1, 1], [0, 0, 0, 1], self.world.root, self.test_body)
    ...
    def test_transform_multiplication(self):
        t = TransformStamped.from_list([1, 2, 3], [0, 0, 0, 1], self.world.root, self.test_body)
        t2 = TransformStamped.from_list([3, 2, 1], [0, 0, 0, 1], self.test_body, self.world.get_body_by_name("r_gripper_tool_frame"))
    ...
    def test_transform_stamped_multiplication(self):
        ...
        self.assertEqual(result.child_frame_id, self.world.get_body_by_name("r_gripper_tool_frame"))
    ...
    def test_transform_multiplication_inverse(self):
        ...
        self.assertEqual(inverse_result.frame_id, self.world.get_body_by_name("r_gripper_tool_frame"))
    ...
    def test_rotation_multiplication(self):
        t1 = TransformStamped.from_list([0, 0, 0], [0, 0, 1, 1], self.world.root, self.robot_view.root)
        t2 = TransformStamped.from_list([0, 0, 0], [0, 0, 1, 0], self.robot_view.root, self.world.get_body_by_name("r_gripper_tool_frame"))
