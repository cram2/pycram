...
def _apply_ik(robot: Object, joint_poses: List[float], joints: List[str]) -> None:
    """
...
def calculate_wrist_tool_offset(wrist_frame: str, tool_frame: str, robot: Object) -> Tuple[List[float], List[float]]:
...
def inverseTimes(transform1: Tuple[List[float], List[float]], transform2: Tuple[List[float], List[float]]) -> Tuple[List[float], List[float]]:
    """
