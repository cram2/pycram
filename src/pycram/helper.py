...
def get_robot_description_path(
    robot_relative_dir: str,
    robot_name: str,
    ...
    """
    resources_dir = (
        find_multiverse_resources_path() if resources_dir is None else resources_dir
    )
    if resources_dir is None:
        logger.info(
            "Could not find Multiverse resources path and no other resources were given."
        )
        return None
