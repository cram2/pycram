...
t_ActionDescription = Table(
    ...
    Column('tasktreenode_id', ForeignKey('TaskTreeNode.id')),
...
t_DetectAction = Table(
    ...
    Column('state', Enum(pycram.datastructures.enums.DetectionState), nullable=False),
    Column('region', JSON)
)
...
t_FrozenObject = Table(
    ...
    Column('detectaction_id', ForeignKey('DetectAction.id')),
    Column('releaseaction_id', ForeignKey('ReleaseAction.id')),
    Column('gripaction_id', ForeignKey('GripAction.id')),
    Column('reachtopickupaction_id', ForeignKey('ReachToPickUpAction.id')),
    Column('pickupaction_id', ForeignKey('PickUpAction.id')),
    Column('placeaction_id', ForeignKey('PlaceAction.id')),
    Column('transportaction_id', ForeignKey('TransportAction.id'))
)
...
t_GraspDescription = Table(
    ...
    Column('vertical_alignment', Enum(pycram.datastructures.enums.Grasp), nullable=False),
...
t_PoseStamped = Table(
    ...
    Column('frozenobject_id', ForeignKey('FrozenObject.id')),
    Column('polymorphic_type', String)
)
...
m_TaskTreeNode = mapper_registry.map_imperatively(pycram.orm.model.TaskTreeNode, t_TaskTreeNode, properties = dict(action=relationship("ActionDescription", foreign_keys=[t_TaskTreeNode.c.action_id], default_factory=list), 
parent=relationship("TaskTreeNode", foreign_keys=[t_TaskTreeNode.c.parent_id], default_factory=list)))
...
m_FrozenObject = mapper_registry.map_imperatively(pycram.datastructures.dataclasses.FrozenObject, t_FrozenObject, properties = dict(pose=relationship("PoseStamped", foreign_keys=[t_FrozenObject.c.pose_id], default_factory=list)))
...
m_DetectAction = mapper_registry.map_imperatively(pycram.designators.action_designator.DetectAction, t_DetectAction, properties = dict(object_at_execution=relationship("FrozenObject", foreign_keys=[t_DetectAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "DetectAction", inherits = m_ActionDescription)
...
m_ReleaseAction = mapper_registry.map_imperatively(pycram.designators.action_designator.ReleaseAction, t_ReleaseAction, properties = dict(object_at_execution=relationship("FrozenObject", foreign_keys=[t_ReleaseAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "ReleaseAction", inherits = m_ActionDescription)

m_GripAction = mapper_registry.map_imperatively(pycram.designators.action_designator.GripAction, t_GripAction, properties = dict(object_at_execution=relationship("FrozenObject", foreign_keys=[t_GripAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "GripAction", inherits = m_ActionDescription)
...
object_at_execution=relationship("FrozenObject", foreign_keys=[t_ReachToPickUpAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "ReachToPickUpAction", inherits = m_ActionDescription)
...
object_at_execution=relationship("FrozenObject", foreign_keys=[t_PickUpAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "PickUpAction", inherits = m_ActionDescription)
...
object_at_execution=relationship("FrozenObject", foreign_keys=[t_PlaceAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "PlaceAction", inherits = m_ActionDescription)
...
object_at_execution=relationship("FrozenObject", foreign_keys=[t_TransportAction.c.object_at_execution_id], default_factory=list)), polymorphic_identity = "TransportAction", inherits = m_ActionDescription)
