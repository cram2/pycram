...
t_GraspDescription = Table(
    ...
    Column('id', Integer, primary_key=True),
    Column('approach_direction', Enum(pycram.datastructures.enums.ApproachDirection), nullable=False),
    Column('vertical_alignment', Enum(pycram.datastructures.enums.VerticalAlignment), nullable=False),
...
t_TransportAction = Table(
    ...
    Column('place_rotation_agnostic', Boolean),
    Column('object_at_execution_id', ForeignKey('FrozenObject.id'))
)
