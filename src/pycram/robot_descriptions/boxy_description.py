import rospkg
from ..new_robot_description import RobotDescription, CameraDescription, KinematicChainDescription, \
...
right_gripper.add_static_joint_states("open", {"right_gripper_joint": 0.548})
right_gripper.add_static_joint_states("close", {"right_gripper_joint": 0.0})
...
left_gripper.add_static_joint_states("open", {"left_gripper_joint": 0.548})
left_gripper.add_static_joint_states("close", {"left_gripper_joint": 0.0})
