...
left_gripper.add_static_joint_states("open", {'gripper_left_left_finger_joint': 0.048,
                                              'gripper_left_right_finger_joint': 0.048})

left_gripper.add_static_joint_states("close", {'gripper_left_left_finger_joint': 0.0,
...
right_gripper.add_static_joint_states("open", {'gripper_right_left_finger_joint': 0.048,
                                               'gripper_right_right_finger_joint': 0.048})

right_gripper.add_static_joint_states("close", {'gripper_right_left_finger_joint': 0.0,
