...
right_arm.add_static_joint_states(StaticJointState.Park, {'ur5_shoulder_pan_joint': 3.23,
...
################################# Grasps ##################################
right_gripper.update_all_grasp_orientations([0.707, -0.707, 0.707, -0.707])
