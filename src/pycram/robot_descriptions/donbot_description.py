...
################################## Right Arm ##################################
right_arm = KinematicChainDescription("right_arm", "ur5_base_link", "ur5_wrist_3_link", donbot_description.urdf_object)
...
right_gripper.add_static_joint_states("open", {'gripper_joint': 0.0})
right_gripper.add_static_joint_states("close", {'gripper_joint': 0.2})
