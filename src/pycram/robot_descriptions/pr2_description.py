...
pr2_description = RobotDescription(
    "pr2",
    "base_link",
    "torso_lift_link",
    "torso_lift_joint",
...
left_gripper.add_static_joint_states(
    GripperState.OPEN,
    {"l_gripper_l_finger_joint": 0.548, "l_gripper_r_finger_joint": 0.548},
)
left_gripper.add_static_joint_states(
    GripperState.CLOSE,
    {"l_gripper_l_finger_joint": 0.0, "l_gripper_r_finger_joint": 0.0},
)
...
right_gripper.add_static_joint_states(
    GripperState.OPEN,
    {"r_gripper_l_finger_joint": 0.548, "r_gripper_r_finger_joint": 0.548},
)
right_gripper.add_static_joint_states(
    GripperState.CLOSE,
    {"r_gripper_l_finger_joint": 0.0, "r_gripper_r_finger_joint": 0.0},
)
...
camera = CameraDescription(
    "kinect_camera", "wide_stereo_optical_frame", 1.27, 1.60, 0.99483, 0.75049
)
pr2_description.add_camera_description(camera)

################################## Torso ##################################
torso = KinematicChainDescription(
    "torso", "base_link", "torso_lift_link", pr2_description.urdf_object
)
