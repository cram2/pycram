...
################################## Arm ##################################
arm = KinematicChainDescription("manipulator", "base_link", "wrist_3_link", ur5_description.urdf_object)
...
gripper.add_static_joint_states("open", {'robotiq_85_left_finger_joint': 0.0,
...
gripper.add_static_joint_states("close", {'robotiq_85_left_finger_joint': 1,
