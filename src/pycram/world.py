...
class BulletWorld:
    ...
    def detach(self, obj1: Object, obj2: Object) -> None:
        """
    ...
    def reset_joint_state(self, obj: Object, joint_name: str, joint_pose: float) -> None:
        """
        Reset the joint state instantly without physics simulation
...
class Object:
    ...
    def remove(self) -> None:
        ...
        if self.world.shadow_world is not None:
    ...
    def set_joint_state(self, joint_name: str, joint_pose: float) -> None:
        ...
        if not low_lim <= joint_pose <= up_lim:
            ...
            # return
        self.world.reset_joint_state(self, joint_name, joint_pose)
    ...
    def _init_current_joint_states(self) -> None:
        ...
        for joint_name in self.joints.keys():
            self._current_joint_states[joint_name] = self.world.get_object_joint_position(self, joint_name)
