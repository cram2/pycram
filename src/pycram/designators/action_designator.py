...
from pycram.ontology import OntologyOWL
...
class MoveTorsoAction(ActionDesignatorDescription):
    ...
    def __init__(self, positions: List[float], resolver=None, onto_concept: Thing = None):
        """
...
class SetGripperAction(ActionDesignatorDescription):
    ...
    def __init__(self, grippers: List[str], motions: List[str], resolver=None, onto_concept: Thing = None):
        """
...
class ReleaseAction(ActionDesignatorDescription):
    ...
    def __init__(self, grippers: List[str], object_designator_description: ObjectDesignatorDescription,
                 resolver=None, onto_concept: Thing = None):
        super().__init__(resolver, onto_concept)
        self.grippers: List[str] = grippers
...
class GripAction(ActionDesignatorDescription):
    ...
    def __init__(self, grippers: List[str], object_designator_description: ObjectDesignatorDescription,
                 efforts: List[float], resolver=None, onto_concept: Thing = None):
        super().__init__(resolver, onto_concept)
        self.grippers: List[str] = grippers
...
class ParkArmsAction(ActionDesignatorDescription):
    ...
    def __init__(self, arms: List[Arms], resolver=None, onto_concept: Thing = None):
        """
...
class PickUpAction(ActionDesignatorDescription):
    ...
    def __init__(self, object_designator_description:  Union[ObjectDesignatorDescription, ObjectDesignatorDescription.Object],
                 arms: List[str], grasps: List[str], resolver=None, onto_concept: Thing = None):
        """
...
class PlaceAction(ActionDesignatorDescription):
    ...
    def __init__(self,
                 ...
                 arms: List[str], resolver=None, onto_concept: Thing = None):
        """
...
class NavigateAction(ActionDesignatorDescription):
    ...
    def __init__(self, target_locations: List[Pose], resolver=None, onto_concept: Thing = None):
        """
...
class TransportAction(ActionDesignatorDescription):
    ...
    def __init__(self,
                 object_designator_description: Union[ObjectDesignatorDescription, ObjectDesignatorDescription.Object],
                 arms: List[str],
                 target_locations: List[Pose], resolver=None, onto_concept: Thing = None):
        """
...
class LookAtAction(ActionDesignatorDescription):
    ...
    def __init__(self, targets: List[Pose], resolver=None, onto_concept: Thing = None):
        """
...
class DetectAction(ActionDesignatorDescription):
    ...
    def __init__(self, object_designator_description: ObjectDesignatorDescription, resolver=None, onto_concept: Thing = None):
        """
...
class OpenAction(ActionDesignatorDescription):
    ...
    def __init__(self, object_designator_description: ObjectPart, arms: List[str], resolver=None, onto_concept: Thing = None):
        """
...
class GraspingAction(ActionDesignatorDescription):
    ...
    def __init__(self, arms: List[str], object_description: Union[ObjectDesignatorDescription, ObjectPart],
                 resolver: Callable = None, onto_concept: Thing = None):
        """
