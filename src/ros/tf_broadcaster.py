...
class TFBroadcaster(ROSTopicPublisher):
    def __init__(self, bullet_world, map_frame, odom_frame, projection_namespace, kitchen_namespace, interval=0.1):
        ...
        self.tf_static_publisher = roslibpy.Topic(self.ros_client, "/tf_static", "tf2_msgs/TFMessage")
        self.tf_publisher = roslibpy.Topic(self.ros_client, "/tf", "tf2_msgs/TFMessage")
        self.thread = None
